...
const updateDocProfile = async (req, res) => {
    try {
        const { docId, fees, address, available, experience, about, name } = req.body
        await doctorModal.findByIdAndUpdate(docId, { fees, address, available, experience, about, name })
