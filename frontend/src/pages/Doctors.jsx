...
const Doctors = () => {
    ...
    return (
        <div>
            <p style={{ fontWeight: "bold", color: `${(theme === '#0f1214') ? '#0ef' : 'black'}`, letterSpacing:"1.5px" , fontFamily:"sans-serif"}} className=' fornt-medium w-full text-2xl border-primary text-center border-b-4 py-4 '>OUR DOCTORS</p>
