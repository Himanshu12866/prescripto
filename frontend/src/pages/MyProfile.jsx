...
const MyProfile = () => {
    const { userData, setUserData, token, backendURL, userProfile } = useContext(AppContext)
        ...
        <div className='max-w-lg flex flex-col gap-2 text-sm mb-52'>
            {
                isEdit ? <label htmlFor='image' >
                    <div className='inline-block relative'>
                        <img className='w-36 rounded cursor-pointer opacity-100' src={image ? URL.createObjectURL(image) : userData.image} />
