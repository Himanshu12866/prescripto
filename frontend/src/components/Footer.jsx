...
const Footer = () => {
    const { textTheme, theme } = useContext(AppContext)
    return (
            ...
            <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-10 text-sm'>
                ...
                <div>
                    ...
                    <ul style={{ backgroundColor: `${(theme === '#0f1214') ? '#0f1214' : 'white'}`, color: `${(theme === '#0f1214') ? 'white' : 'black'}` }} className='flex  flex-col gap-2 text-gray-900'>
                        ...
                        <li className=''><Button variant='contained'color='error' ><a href='https://drbookwebapp-admin.onrender.com/'>Admin Login</a></Button></li>
                    </ul>
                </div>
