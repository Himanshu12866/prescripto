  ...
  return (
    ...
    {/* Left Side  */}
        <div className='flex-1 py-8 md:py-16 lg:py-24  lg:pl-5'>
            ...
            <button onClick={() => {navigate("/login") , scrollTo(0,0)}} className='bg-white rounded-full text-black text-sm sm:text-base px-8 py-3 mt-2 hover:scale-105 transition-all duration-300' >
                Create Account
            </button>
        </div>
