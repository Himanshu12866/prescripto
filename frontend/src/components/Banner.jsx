    ...
    return (
        <div className='flex rounded-lg px-6   sm:px-10 lg:px-14 md:px-10 xl:px-16' style={{ backgroundColor: `${theme === 'white' ? '#5f6FFF' : '#950101'}` }}>
            ...
            <div className='flex-1 py-8 md:py-16 lg:py-24  lg:pl-5'>
                ...
                {
                    token ? (<button style={{ backgroundColor: `${(theme === '#0f1214') ? '#0f1214' : 'white'}`, color: `${(theme === '#0f1214') ? 'white' : 'black'}` }}className=' rounded-full  text-sm sm:text-base px-8 py-3 mt-2 hover:scale-105 transition-all duration-300' >
                        Book Appointment
                    </button>
                    ) :
