...
const Header = () => {
    ...
    return (
        <div style={{ backgroundColor: `${(theme === '#0f1214') ? '#950100' : '#424242'}`, color: `${(theme === '#0f1214') ? 'white' : 'black'}` }} className='flex flex-col md:flex-row flex-wrap  rounded-lg px-6 -z-50 md:px-10 lg:px-20'>
