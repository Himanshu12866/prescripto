    ...
    return (
        <div className='flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20'>
            <div className='md:w-1/2 flex flex-col justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px] '>
                ...
                <button  className='flex items-center gap-2 bg-white rounded-full py-3 px-8 me-10 w-8/10 text-gray-700  text-sm m-auto md:m-0 hover:scale-105 transition-all duration-200'>
